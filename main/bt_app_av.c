...
#if 0
    if (++m_pkt_cnt % 100 == 0) {
      ESP_LOGI(BT_AV_TAG, "audio data pkt cnt %u,len=%u", m_pkt_cnt,len);
    }
#endif
    i2sdac_write(data, len);
}
